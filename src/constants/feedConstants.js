export const feedConstants = {
    ...
    MARK_FAVORITE_REQUEST: 'MARK_FAVORITE_REQUEST',
    MARK_FAVORITE_SUCCESS: 'MARK_FAVORITE_SUCCESS',
    MARK_FAVORITE_ERROR: 'MARK_FAVORITE_ERROR',

    MARK_ARTICLE_FAVORITE_REQUEST: 'MARK_ARTICLE_FAVORITE_REQUEST',
    MARK_ARTICLE_FAVORITE_SUCCESS: 'MARK_ARTICLE_FAVORITE_SUCCESS',
    MARK_ARTICLE_FAVORITE_ERROR: 'MARK_ARTICLE_FAVORITE_ERROR',
};
