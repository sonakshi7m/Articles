...
const getFavIcon = (favorites, count, slug, handleClick) => {
    ...
    if (!favorites) {
        return (
            <div className={classes} onClick={() => handleClick('post', slug, favorites)}>
                <svg
    ...
    return (
        <div className="info-action" onClick={() => handleClick('delete', slug, favorites)}>
            <svg
